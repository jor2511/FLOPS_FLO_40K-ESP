...
[parseText '<t color=""#1AA3FF"" font=""PuristaBold"" align = ""right"" shadow = ""1"" size=""2"">SITREP</t><br /><t color=""#959393"" align = ""right"" shadow = ""1"" size=""0.8"">Nuestras fuerzas controlan esta zona,</t><br /><t color=""#959393"" align = ""right"" shadow = ""1"" size=""0.8"">Mantened la posicion y capturaremos este objetivo,</t>', [0, 0.5, 1, 1], nil, 5, 1.7, 0] remoteExec ['BIS_fnc_textTiles', 0];
...
_FOBMrk = [_allMarks,  thisTrigger] call BIS_fnc_nearestPosition;
						_FOBMrk setMarkerColor 'ColorGrey' ;	
								...
								[[west,'HQ'], 'Fuerzas aliadas controlan la zona ' + _attackingAtGrid] remoteExec ['sideChat', 0];
