...
[parseText '<t color=""#1AA3FF"" font=""PuristaBold"" align = ""right"" shadow = ""1"" size=""2"">SITREP</t><br /><t color=""#959393"" align = ""right"" shadow = ""1"" size=""0.8"">Dominamos la batalla,</t><br /><t color=""#959393"" align = ""right"" shadow = ""1"" size=""0.8"">Manteneros hasta lleguen los refuerzos,</t>', [0, 0.5, 1, 1], nil, 5, 1.7, 0] remoteExec ['BIS_fnc_textTiles', 0];
...
_FOBMrk = [_allMarks,  thisTrigger] call BIS_fnc_nearestPosition;
						_FOBMrk setMarkerColor 'ColorGrey' ;	
								...
								[[west,'HQ'], 'Zona asegurada en: ' + _attackingAtGrid] remoteExec ['sideChat', 0];
...
_FOBMrk = [_allMarks,  thisTrigger] call BIS_fnc_nearestPosition;
						_FOBMrk setMarkerColor 'colorOPFOR' ;	
									_attackingAtGrid = mapGridPosition getMarkerPos _FOBMrk;
								[[west,'HQ'], 'Nueva captura en: ' + _attackingAtGrid] remoteExec ['sideChat', 0];
"]; 
