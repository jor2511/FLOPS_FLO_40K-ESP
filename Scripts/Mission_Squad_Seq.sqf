...
[PRL, getPos _HQB, 200] call BIS_fnc_taskPatrol;
								...
								["showNotification", ["+ NUEVA INTEL", "Intel Militar Recibida", "intel"]] call FLO_fnc_intelSystem;
									_attackingAtGrid = mapGridPosition getMarkerPos _mrkr;
								[[west,"MTI"], "Presencia enemiga en coordenadas: " + _attackingAtGrid] remoteExec ["sideChat", 0];
